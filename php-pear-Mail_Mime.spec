...
Summary:	%{_pearname} - provides classes to create mime messages
...
of mime messages. It allows people to create email messages consisting
of text parts, HTML parts, inline HTML images, attachments and 
attached messages.
